        ...
        <div id="auth-left">
            ...
            <form action="<?= base_url("auth/register_process") ?>" method="POST">
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="text" id="email" name="email" class="form-control form-control-xl" value="<?= set_value('email') ?>" placeholder="Email">
                ...
                <div class="form-group position-relative has-icon-left mb-4">
                    <input type="password" id="passconf" name="passconf" class="form-control form-control-xl" placeholder="Confirm Password">
            ...
            <div class="text-center mt-5 text-lg fs-4">
                <p class='text-gray-600'>Already have an account? <a href="<?= base_url("auth/login") ?>" class="font-bold">Log in</a>.</p>
            </div>
        </div>
    </div>
