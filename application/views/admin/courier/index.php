            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-6 text-end">
                        <a href="<?= base_url('admin/courier/create') ?>" class="btn btn-primary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <a href="<?= base_url('admin/courier/edit/' . $courier->id) ?>"
                                                class="btn btn-sm btn-outline-warning"
                                                title="Edit User">
                                                <i class="bi bi-pencil"></i>
                                            </a>
                                            <a href="<?= base_url('admin/courier/delete/' . $courier->id) ?>"
