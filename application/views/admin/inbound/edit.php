    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Edit Inbound</h3>
                <p class="text-subtitle text-muted">Update inbound shipment information</p>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('admin/inbound/update/' . $shipment->id) ?>" method="POST" class="form form-horizontal">
                            <div class="form-body">
                                <div class="row">
                                                ...
                                                <select id="courier_id"
                                                    ...
                                                    <?php foreach ($couriers as $courier) : ?>
                                                        <option value="<?= $courier->id ?>"
                                                            <?= set_select('courier_id', $courier->id, $shipment->courier_id == $courier->id) ?>>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="status"
                                                    ...
                                                    <option value="pending" <?= set_select('status', 'pending', $shipment->status == 'pending') ?>>Pending</option>
                                                    <option value="received" <?= set_select('status', 'received', $shipment->status == 'received') ?>>Received</option>
                                                    <option value="problem" <?= set_select('status', 'problem', $shipment->status == 'problem') ?>>Problem</option>
                                                    <option value="cancelled" <?= set_select('status', 'cancelled', $shipment->status == 'cancelled') ?>>Cancelled</option>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="sender_name"
                                                    ...
                                                    value="<?= set_value('sender_name', $shipment->sender_name) ?>" required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="tel" id="sender_phone"
                                                    ...
                                                    value="<?= set_value('sender_phone', $shipment->sender_phone) ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea id="sender_address"
                                                    ...
                                                    rows="2"><?= set_value('sender_address', $shipment->sender_address) ?></textarea>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" id="receiver_name"
                                                    ...
                                                    value="<?= set_value('receiver_name', $shipment->receiver_name) ?>" required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="tel" id="receiver_phone"
                                                    ...
                                                    value="<?= set_value('receiver_phone', $shipment->receiver_phone) ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea id="receiver_address"
                                                    ...
                                                    rows="2"><?= set_value('receiver_address', $shipment->receiver_address) ?></textarea>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea id="package_description"
                                                    ...
                                                    rows="2"><?= set_value('package_description', $shipment->package_description) ?></textarea>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" step="0.01" id="package_weight"
                                                    ...
                                                    value="<?= set_value('package_weight', $shipment->package_weight) ?>">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea id="notes"
                                                    ...
                                                    rows="2"><?= set_value('notes', $shipment->notes) ?></textarea>
                                ...
                                <div class="row mt-4">
                                    <div class="col-12 d-flex justify-content-end">
                                        ...
                                        <button type="submit" class="btn btn-primary me-1 mb-1">
                                            <i class="bi bi-check-circle"></i> Update Inbound
                                        </button>
                                    </div>
                                </div>
                            </div>
