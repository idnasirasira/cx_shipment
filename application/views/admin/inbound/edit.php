        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Edit Inbound</h3>
                    <p class="text-subtitle text-muted">Edit data inbound</p>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?= base_url('admin/inbound/update/' . $inbound->id) ?>" method="POST" class="form form-horizontal">
                                <div class="form-body">
                                    <div class="row">
                                        <!-- Sender Information -->
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="sender_name" class="form-control " name="sender_name" placeholder="Enter sender name" value="<?= $inbound->sender_name ?>" required="">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="sender_phone" class="form-control " name="sender_phone" placeholder="Enter sender phone" value="<?= $inbound->sender_phone ?>" required="">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea id="sender_address" class="form-control " name="sender_address" placeholder="Enter sender address" rows="3"><?= $inbound->sender_address ?></textarea>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="receiver_name" class="form-control " name="receiver_name" placeholder="Enter receiver name" value="<?= $inbound->receiver_name ?>" required="">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="receiver_phone" class="form-control " name="receiver_phone" placeholder="Enter receiver phone" value="<?= $inbound->receiver_phone ?>" required="">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="received_by" class="form-control " name="received_by" placeholder="Enter received by" value="<?= $inbound->received_by ?>"></input>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea id="receiver_address" class="form-control " name="receiver_address" placeholder="Enter receiver address" rows="3"><?= $inbound->receiver_address ?></textarea>
                                        ...
                                        <div class="col-md-6">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <select id="courier" class="form-select " name="courier" required="">
                                                        ...
                                                        <?php foreach ($courier as $couriers): ?>
                                                            <option value="<?= $couriers->id ?>" <?= ($couriers->id == $inbound->courier_id) ? 'selected' : ''; ?>>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="package_description" class="form-control " name="package_description" placeholder="Enter package description" value="<?= $inbound->package_description ?>" required="">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" id="package_weight" class="form-control " name="package_weight" placeholder="Enter package weight" value="<?= $inbound->package_weight ?>" required="">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea id="notes" class="form-control " name="notes" placeholder="Enter the notes" rows="3"><?= $inbound->notes ?></textarea>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-12 d-flex justify-content-end">
                                            ...
                                            <button type="submit" class="btn btn-primary me-1 mb-1">
                                                <i class="bi bi-check-circle"></i> Edit User
                                            </button>
                                        </div>
                                    </div>
                                </div>
